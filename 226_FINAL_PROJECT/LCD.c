...
//FUNCTION THAT INITIALIZE THE LCD SCREEN FOR USE (4 BIT MODE, SCREEN ON, CURSOR AT THE TOP LEFT POSITION BLINKING)
void LCD_init(void){
...
//FUNCTION USED TO RIGHT A BYTE OF DATA (THE INPUT) AS TWO SEPERATE NIBBLES, THE UPPER THEN LOWER
...
//FUNCTION USED TO SEND COMMANDS TO THE LCD, LIKE MOVING THE CURSOR TO A POSTITION
...
//FUNCTION USED TO SEND DATA TO THE LCD, LIKE TEXT
