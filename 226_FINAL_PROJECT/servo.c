...
#include "menus.h"
#include "buzzer.h"
//Description: function that initializes the servo and the on-board LED, the green and red colors of LED 2
//Inputs: void
//Outputs: void
    void intial_servo(){
...
//Description: FUNCTION THAT TURNS THE MICRO SERVO 90º CLOCKWISE
//Inputs: void
//Outputs: void
void open_servo(){
...
//Description: FUNCTION THAT TURNS THE MICRO SERVO 90º COUNTER CLOCKWISE
//Inputs: void
//Outputs: void
    void close_servo(){
